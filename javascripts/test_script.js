window.onload=(function(){
  /*THis Is the test script for Meridian*/
	...
	var member=Member({
			...
			2:{name:'sandbox>div',attributes:'id>tryit>style>position:relative;background_color:black;padding:10px;width:800px;height:auto;overflow:hidden;border:1px solid black'},
